...
void main() {
  group('LayoutSerializer', () {
    ...
    test('should deserialize layout from JSON string', () {
      ...
      expect(
        deserializedLayout!.dimensions.columns,
        testLayout.dimensions.columns,
      );
    ...
    test('should handle round-trip serialization correctly', () {
      ...
      expect(
        deserializedLayout.widgets.length,
        equals(testLayout.widgets.length),
      );
    ...
    test('should handle missing required fields gracefully', () {
      const incompleteJson =
          '{"version": "1.0.0"}'; // Missing dimensions and widgets
    ...
    test('should handle legacy format gracefully', () {
      ...
      expect(
        layout.widgets.first.properties,
        isEmpty,
    ...
    test('should export layout with export metadata', () {
      ...
      final exportMetadata =
          exportedData['exportMetadata'] as Map<String, dynamic>;
    ...
    test('should migrate layout successfully', () {
      final jsonString = LayoutSerializer.toJsonString(testLayout);
      final migratedLayout = LayoutSerializer.migrateLayout(
        jsonString,
        '1.0.0',
      );
