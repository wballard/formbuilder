...
void main() {
  group('Performance Integration Tests', () {
    ...
    testWidgets('should handle large grid with optimizations', (tester) async {
          ...
          home: Scaffold(
            body: SizedBox(
              ...
              child: WidgetVirtualGrid(
                dimensions: const VirtualGridDimensions(columns: gridSize, rows: gridSize),
      ...
      monitor.startFrame();
      await tester.drag(find.byType(WidgetVirtualGrid), const Offset(-100, -100));
      await tester.pump();
      monitor.endFrame();
    ...
    testWidgets('should optimize state updates with selective rebuilds', (tester) async {
      final state = ValueNotifier<TestComplexState>(
        TestComplexState(counter: 0, data: 'initial', timestamp: DateTime.now()),
      );
    ...
    testWidgets('should adapt performance settings automatically', (tester) async {
    ...
    testWidgets('should handle complex drag operations efficiently', (tester) async {
            ...
            body: Stack(
              children: [
                ...
                OptimizedDraggable<String>(
                  data: 'test',
                  dragQuality: DragQuality.low, // Use low quality for performance
                  feedback: Container(
                    width: 50,
                    height: 50,
      ...
      for (int i = 0; i < 20; i++) {
        ...
        await tester.pump(const Duration(milliseconds: 8)); // 120 FPS simulation
      }
    ...
    testWidgets('should optimize grid rendering with RepaintBoundary', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
    ...
    test('should limit history for memory efficiency', () {
      ...
      expect(history.items, equals(['item5', 'item6', 'item7', 'item8', 'item9']));
    });
