...
void main() {
  group('AnimationSettings', () {
    ...
    test('should get duration based on animation type', () {
      ...
      expect(settings.getDuration(AnimationType.short), const Duration(milliseconds: 150));
      expect(settings.getDuration(AnimationType.medium), const Duration(milliseconds: 250));
      expect(settings.getDuration(AnimationType.long), const Duration(milliseconds: 350));
    });
    ...
    testWidgets('should create settings from MediaQuery', (WidgetTester tester) async {
