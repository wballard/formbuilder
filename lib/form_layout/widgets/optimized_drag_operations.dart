...
class _ThrottledDragTargetState<T extends Object>
    extends State<ThrottledDragTarget<T>> {
...
class _OptimizedDraggableState<T extends Object>
    extends State<OptimizedDraggable<T>> {
  ...
  Widget _buildOptimizedFeedback() {
    switch (_currentQuality) {
      ...
      case DragQuality.medium:
        return Opacity(opacity: 0.8, child: widget.feedback);
      case DragQuality.low:
        return Opacity(
          opacity: 0.6,
          child: Transform.scale(scale: 0.9, child: widget.feedback),
        );
    }
  }
...
class DragDropPerformanceWrapper extends StatefulWidget {
  ...
  @override
  State<DragDropPerformanceWrapper> createState() =>
      _DragDropPerformanceWrapperState();
}
...
class _DragDropPerformanceWrapperState extends State<DragDropPerformanceWrapper>
  ...
  void _startPerformanceMonitoring() {
    _performanceTimer = Timer.periodic(const Duration(milliseconds: 100), (_) {
  ...
  @override
  Widget build(BuildContext context) {
    return _DragPerformanceProvider(optimizer: _optimizer, child: widget.child);
  }
}
